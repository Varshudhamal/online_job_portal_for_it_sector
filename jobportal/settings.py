...
SECRET_KEY = 'django-insecure-$!436smaw))*bosry0-@nqae*q_t+4v*bk=fr6c)7(5y)-_ely'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR /'jobs'/ 'static',  # This should be the path where your static files (CSS, JS, images) are stored
]
...
# settings.py
LOGIN_URL = 'login'  # This should match the name of your login URL in urls.py
...
# Define the file system path for media files
